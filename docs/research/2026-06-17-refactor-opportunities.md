...
- **Gates (CI):** `ci:tier-coherence`, `ci:source-provenance-coherence`, `ci:tally-golden`, `ci:magnitude-golden`, `ci:docs-drift`, `ci:bad-conversions-stub`, plus 955 vitest tests and `tsc`. Any change touching regions/loaders risks golden-file churn across these.
