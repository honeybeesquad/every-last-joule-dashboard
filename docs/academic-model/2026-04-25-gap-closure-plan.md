...
| T3-modelled | Typical profile scaled to annual — solar / wind / mixed / hydro-seasonal / overnight shape families across 56 v0.5 regions including the Chinese provinces, most of South Asia, Africa, the Middle East outside flare, Latin America outside Brazil/Argentina, and Hawaii | `0.4 × peakGW` (profile-shape assumption) | ±40% |
