# Validation — Kosovo Wind (`kosovo-wind`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `kosovo-wind`
- **Country:** XKX
- **Tier:** estimated
- **Kind:** wind
- **Source:** KOSTT A75 wind generation. Waste unpublished; empty A75 stays a grid marker.
...
- Backfill archive: `data/historical/backfill/*_kosovo-wind_*.parquet` (0 years)
