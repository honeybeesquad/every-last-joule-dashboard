# Validation — Algeria (flare) (`algeria-flare`)

Last updated: 2026-06-17 · GGFR per-flare-site split · T2 flare

## Source

- **Region id:** `algeria-flare`
- **Country:** DZA
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Algeria national, 7.8820 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 7.8820 bcm flared × 3.6925 TWh-e/bcm = 29.1 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_algeria-flare_*.parquet` (0 years)
