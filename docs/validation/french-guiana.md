...
- **Region id:** `french-guiana`
- **Country:** GUF
- **Tier:** static
- **Kind:** solar
- **Source:** EDF SEI Bilan Previsionnel Guyane 2024 (below normal inclusion threshold; included for completeness as the only South-American French overseas territory)
- **Source URL:** [https://www.edf.fr/edf-sei/](https://www.edf.fr/edf-sei/)
...
- Backfill archive: `data/historical/backfill/*_french-guiana_*.parquet` (0 years)
