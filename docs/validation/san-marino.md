# Validation — San Marino (`san-marino`)

Last updated: 2026-06-17 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `san-marino`
- **Country:** SMR
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / AASS (~25 MW solar; part of Italian grid)
...
- Backfill archive: `data/historical/backfill/*_san-marino_*.parquet` (0 years)
