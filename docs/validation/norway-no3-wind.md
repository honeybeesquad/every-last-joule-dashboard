# Validation — Norway NO3 Wind (Trondheim) (`norway-no3-wind`)
...
- **Tier:** live
- **Kind:** wind
- **Source:** ENTSO-E NO3 onshore wind
...
- Backfill archive: `data/historical/backfill/*_norway-no3-wind_*.parquet` (0 years)
