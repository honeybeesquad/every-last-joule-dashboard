# Validation — New Caledonia (`new-caledonia`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `new-caledonia`
- **Country:** NCL
- **Tier:** estimated
- **Kind:** solar
- **Source:** Enercal. No hourly series wired. Waste unpublished.
- **Source URL:** [https://www.enercal.nc/](https://www.enercal.nc/)
...
- Backfill archive: `data/historical/backfill/*_new-caledonia_*.parquet` (0 years)
