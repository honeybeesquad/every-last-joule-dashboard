# Validation — Khurmala Dome (flare) (`khurmala`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Khurmala Dome, 0.4236 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.4236 bcm flared × 3.6925 TWh-e/bcm = 1.6 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_khurmala_*.parquet` (0 years)
