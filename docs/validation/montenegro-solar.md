# Validation — Montenegro Solar (`montenegro-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `montenegro-solar`
- **Country:** MNE
- **Tier:** estimated
- **Kind:** solar
- **Source:** CGES A75 solar generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_montenegro-solar_*.parquet` (0 years)
