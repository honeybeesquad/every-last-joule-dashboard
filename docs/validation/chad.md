...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / SNE Chad (diesel + emerging solar; large landlocked grid)
...
- Backfill archive: `data/historical/backfill/*_chad_*.parquet` (0 years)
