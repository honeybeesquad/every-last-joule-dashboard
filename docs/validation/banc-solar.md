# Validation — BANC Solar (`banc-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `banc-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 BANC generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_banc-solar_*.parquet` (0 years)
