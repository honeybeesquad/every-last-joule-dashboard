# Validation — Terrazas Nuevas Wind (`wind-terras-nuevas`)

Last updated: 2026-06-18 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `wind-terras-nuevas`
- **Country:** PER
- **Tier:** estimated
- **Kind:** wind
- **Source:** COES per-plant generation × 2% curtailment estimate
...
- Backfill archive: `data/historical/backfill/*_wind-terras-nuevas_*.parquet` (0 years)
