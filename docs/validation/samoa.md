...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / EPC Samoa (~25 MW solar + hydro; Pacific island grid)
...
- Backfill archive: `data/historical/backfill/*_samoa_*.parquet` (0 years)
