...
- **Region id:** `china-tianjin`
- **Country:** CHN
- **Tier:** static
- **Kind:** mixed
- **Source:** NEA 2024 provincial RE monitoring bulletin — mixed wind+solar curtailment ~0.16 TWh/yr
...
- **Loader:** [`china-tianjin.json.ts`](../../src/data/china-tianjin.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-tianjin.json.ts`](../../src/data/china-tianjin.json.ts)
- Backfill archive: `data/historical/backfill/*_china-tianjin_*.parquet` (0 years)
