# Validation — Heilongjiang Solar (`china-heilongjiang-solar`)

Last updated: 2026-08-20 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `china-heilongjiang-solar`
- **Country:** CHN
- **Tier:** estimated
- **Kind:** solar
- **Source:** Ember China subnational generation (trailing 12mo) × NEA 2024 curtailment rate 3.4% (utilisation 96.6%); refreshed anchor, T3-modelled shape
...
- Backfill archive: `data/historical/backfill/*_china-heilongjiang-solar_*.parquet` (0 years)
