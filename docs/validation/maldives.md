...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / STELCO (~50 MW solar+diesel hybrid island grid)
...
- Backfill archive: `data/historical/backfill/*_maldives_*.parquet` (0 years)
