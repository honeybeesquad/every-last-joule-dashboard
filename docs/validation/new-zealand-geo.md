...
- **Tier:** live
- **Kind:** geo
- **Source:** EMI DispatchNodalPricesAndVolumes ≤$0/MWh nodal price signal (Wairakei, Rotokawa, Nga Awa Purua, Te Mihi)
...
- Backfill archive: `data/historical/backfill/*_new-zealand-geo_*.parquet` (0 years)
