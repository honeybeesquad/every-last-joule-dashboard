# Validation — N. Iraq other fields (flare) (`n-iraq`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (N. Iraq residual, 2.0069 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 2.0069 bcm flared × 3.6925 TWh-e/bcm = 7.4 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_n-iraq_*.parquet` (0 years)
