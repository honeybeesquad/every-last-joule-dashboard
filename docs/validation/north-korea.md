...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / 38North estimate (isolated grid, ~50 MW solar; no public data)
...
- Backfill archive: `data/historical/backfill/*_north-korea_*.parquet` (0 years)
