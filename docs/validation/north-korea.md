# Validation — North Korea (`north-korea`)

Last updated: 2026-05-05 · Phase 4-A completionist Tier A

## Source

- **Region id:** `north-korea`
- **Country:** PRK
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / 38North estimate (isolated grid, ~50 MW solar; no public data); modelled curtailment ~2% per regional default
...
|--------|-------|---------|
| IRENA RCS 2025 | ~50 MW solar (estimated) | 2024 |
