# Validation — Micronesia (`micronesia`)

Last updated: 2026-05-05 · Phase 4-C completionist Tier C

## Source

- **Region id:** `micronesia`
- **Country:** FSM
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / CPUC (~3 MW PV + diesel; island grid); modelled curtailment ~2% per regional default
