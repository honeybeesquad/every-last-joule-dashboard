...
- **Loader:** [`ipco.json.ts`](../../src/data/ipco.json.ts)
- **Structural gap:** no

## Calibration

- **Rate:** 2.0% of EIA-930 solar generation (conservative first-order anchor).
- **Anchor basis:** Idaho Power IRP 2023 (PURPA curtailment).
...
- Loader source: [`ipco.json.ts`](../../src/data/ipco.json.ts)
