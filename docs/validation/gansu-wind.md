...
- **Region id:** `gansu-wind`
- **Country:** CHN
- **Tier:** estimated
- **Kind:** wind
- **Source:** Ember China subnational generation (trailing 12mo) × NEA 2024 curtailment rate 6.1% (utilisation 93.9%); refreshed anchor, T3-modelled shape
...
- Backfill archive: `data/historical/backfill/*_gansu-wind_*.parquet` (0 years)
