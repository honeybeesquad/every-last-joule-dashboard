# Validation — US Virgin Islands (`us-virgin-islands`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `us-virgin-islands`
- **Country:** VIR
- **Tier:** estimated
- **Kind:** solar
- **Source:** WAPA USVI annual reports. Grid present, ops unpublished.
- **Source URL:** [https://www.viwapa.vi/](https://www.viwapa.vi/)
...
- Backfill archive: `data/historical/backfill/*_us-virgin-islands_*.parquet` (0 years)
