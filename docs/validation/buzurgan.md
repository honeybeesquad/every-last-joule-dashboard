# Validation — Buzurgan (flare) (`buzurgan`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Buzurgan, 1.3479 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 1.3479 bcm flared × 3.6925 TWh-e/bcm = 5.0 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_buzurgan_*.parquet` (0 years)
