# Validation — New South Wales (`aemo-nsw`)
...
- **TSO annual curtailment (latest published):** AEMO 2024 NSW wind+solar curtailment ~0.5 TWh
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_aemo-nsw_*.parquet` (0 years)
