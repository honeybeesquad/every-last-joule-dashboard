# Validation — Los Angeles DWP Solar (`ldwp-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `ldwp-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 LDWP generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_ldwp-solar_*.parquet` (0 years)
