...
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA Botswana 2024 (BPC; SAPP member; Mmadinare PV)
- **Source URL:** [https://www.bpc.bw/](https://www.bpc.bw/)
...
- Backfill archive: `data/historical/backfill/*_botswana_*.parquet` (0 years)
