# Validation — Singapore (`singapore`)
...
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / EMA TES 2024 (~700 MW rooftop+utility PV); modelled curtailment ~2% per regional default
...
|--------|-------|---------|
| IRENA RCS 2025 | ~700 MW rooftop+utility PV | 2024 |
