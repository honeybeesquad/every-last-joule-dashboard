...
- **Tier:** static
- **Kind:** flare
- **Source:** GGFR 2024 Suriname Block 58 offshore flaring forecast (upstream off-grid; at inclusion threshold)
- **Source URL:** [https://www.nvebs.com/](https://www.nvebs.com/)
...
- Backfill archive: `data/historical/backfill/*_suriname_*.parquet` (0 years)
