# Validation — South Sudan (`south-sudan`)

Last updated: 2026-05-05 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `south-sudan`
- **Country:** SSD
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / MEM South Sudan (mostly diesel; new utility PV)
...
- Backfill archive: `data/historical/backfill/*_south-sudan_*.parquet` (0 years)
