# Validation — ERCOT East Solar (`ercot-east-solar`)

Last updated: 2026-05-10 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `ercot-east-solar`
- **Country:** USA
- **Tier:** live
- **Kind:** solar
- **Source:** EIA ERCO solar
...
- Backfill archive: `data/historical/backfill/*_ercot-east-solar_*.parquet` (0 years)
