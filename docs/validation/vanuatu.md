...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / UNELCO (~10 MW PV + hydro + diesel; Pacific islands)
...
- Backfill archive: `data/historical/backfill/*_vanuatu_*.parquet` (0 years)
