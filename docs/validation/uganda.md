...
- **Tier:** static
- **Kind:** hydro
- **Source:** ERA Annual Performance 2024 (UETCL/UEDCL; Karuma+Isimba hydro)
- **Source URL:** [https://www.uetcl.com/](https://www.uetcl.com/)
...
- Backfill archive: `data/historical/backfill/*_uganda_*.parquet` (0 years)
