# Validation — Dominion Energy South Carolina Solar (`sceg-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `sceg-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 SCEG generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_sceg-solar_*.parquet` (0 years)
