# Validation — NV Energy Solar (`nevp-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `nevp-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 NEVP generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_nevp-solar_*.parquet` (0 years)
