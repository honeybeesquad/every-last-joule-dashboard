# Validation — Sierra Leone (`sierra-leone`)

Last updated: 2026-05-10 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `sierra-leone`
- **Country:** SLE
- **Tier:** estimated
- **Kind:** hydro
- **Source:** IRENA RCS 2025 / EDSA (Bumbuna hydro + solar; WAPP)
...
- Backfill archive: `data/historical/backfill/*_sierra-leone_*.parquet` (0 years)
