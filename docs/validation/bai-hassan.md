# Validation — Bai Hassan (flare) (`bai-hassan`)

Last updated: 2026-06-17 · GGFR per-flare-site split · T2 flare

## Source

- **Region id:** `bai-hassan`
- **Country:** IRQ
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Bai Hassan, 0.9213 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.9213 bcm flared × 3.6925 TWh-e/bcm = 3.4 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_bai-hassan_*.parquet` (0 years)
