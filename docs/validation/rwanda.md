...
- **Tier:** static
- **Kind:** mixed
- **Source:** IRENA Rwanda 2024 (REG/EUCL; Lake Kivu methane + hydro+solar)
- **Source URL:** [https://www.reg.rw/](https://www.reg.rw/)
...
- Backfill archive: `data/historical/backfill/*_rwanda_*.parquet` (0 years)
