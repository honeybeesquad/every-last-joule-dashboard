# Validation — Bosnia Wind (`bosnia-wind`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `bosnia-wind`
- **Country:** BIH
- **Tier:** estimated
- **Kind:** wind
- **Source:** NOS BiH A75 wind generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_bosnia-wind_*.parquet` (0 years)
