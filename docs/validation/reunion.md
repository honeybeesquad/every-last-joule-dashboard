...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EDF SEI Réunion. No hourly series wired. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_reunion_*.parquet` (0 years)
