...
- **Region id:** `china-hunan`
- **Country:** CHN
- **Tier:** static
- **Kind:** mixed
- **Source:** NEA 2024 provincial RE monitoring bulletin — mixed wind+solar+hydro curtailment ~1.9 TWh/yr
...
- **Loader:** [`china-hunan.json.ts`](../../src/data/china-hunan.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-hunan.json.ts`](../../src/data/china-hunan.json.ts)
- Backfill archive: `data/historical/backfill/*_china-hunan_*.parquet` (0 years)
