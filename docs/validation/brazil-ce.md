...
- **TSO annual curtailment (latest published):** ONS 2024 CE ~0.9 TWh
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_brazil-ce_*.parquet` (0 years)
