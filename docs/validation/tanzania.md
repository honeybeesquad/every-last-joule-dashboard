...
- **Tier:** static
- **Kind:** hydro
- **Source:** IRENA Tanzania 2024 + JNHPP commissioning (TANESCO; gas+hydro)
- **Source URL:** [https://www.tanesco.co.tz/](https://www.tanesco.co.tz/)
...
- Backfill archive: `data/historical/backfill/*_tanzania_*.parquet` (0 years)
