# Validation — California (Wind) (`caiso-wind`)

Last updated: 2026-04-27 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `caiso-wind`
- **Country:** USA
- **Tier:** live
- **Kind:** wind
- **Source:** CAISO OASIS / EIA (wind only)
...
- Backfill archive: `data/historical/backfill/*_caiso-wind_*.parquet` (0 years)
