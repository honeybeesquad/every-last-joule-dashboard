# Validation — Montenegro Wind (`montenegro-wind`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `montenegro-wind`
- **Country:** MNE
- **Tier:** estimated
- **Kind:** wind
- **Source:** CGES A75 wind generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_montenegro-wind_*.parquet` (0 years)
