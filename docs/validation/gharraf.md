# Validation — Gharraf (flare) (`gharraf`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Gharraf, 0.6946 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.6946 bcm flared × 3.6925 TWh-e/bcm = 2.6 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_gharraf_*.parquet` (0 years)
