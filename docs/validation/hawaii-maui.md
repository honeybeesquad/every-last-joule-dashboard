...
- **Tier:** estimated
- **Kind:** solar
- **Source:** Hawaiian Electric historical curtailment XLSX 2026-05-09: Maui 2024 = 36.4 GWh curtailed from curtailable renewables (curtailment rate ~14%). Annual file only — no daily/monthly programmatic feed. T1 not achievable.
