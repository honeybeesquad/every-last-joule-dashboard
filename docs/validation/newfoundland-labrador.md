# Validation — Newfoundland and Labrador (`newfoundland-labrador`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `newfoundland-labrador`
- **Country:** CAN
- **Tier:** estimated
- **Kind:** hydro
- **Source:** NL Hydro. No hourly TSO series wired. Grid present, ops unpublished.
- **Source URL:** [https://nlhydro.com/](https://nlhydro.com/)
...
- Backfill archive: `data/historical/backfill/*_newfoundland-labrador_*.parquet` (0 years)
