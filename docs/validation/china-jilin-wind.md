...
- **Tier:** estimated
- **Kind:** wind
- **Source:** Ember China subnational generation (trailing 12mo) × NEA 2024 curtailment rate 6.5% (utilisation 93.5%); refreshed anchor, T3-modelled shape
...
- Backfill archive: `data/historical/backfill/*_china-jilin-wind_*.parquet` (0 years)
