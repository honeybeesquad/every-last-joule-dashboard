# Validation — Timor-Leste (`east-timor`)

Last updated: 2026-06-17 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `east-timor`
- **Country:** TLS
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / EDTL (~30 MW solar + diesel; small island grid)
...
- Backfill archive: `data/historical/backfill/*_east-timor_*.parquet` (0 years)
