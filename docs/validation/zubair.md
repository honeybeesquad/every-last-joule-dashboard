# Validation — Zubair (flare) (`zubair`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Zubair, 1.7037 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 1.7037 bcm flared × 3.6925 TWh-e/bcm = 6.3 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_zubair_*.parquet` (0 years)
