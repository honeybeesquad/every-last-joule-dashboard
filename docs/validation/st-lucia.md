...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / LUCELEC (~10 MW PV + diesel; island grid)
...
- Backfill archive: `data/historical/backfill/*_st-lucia_*.parquet` (0 years)
