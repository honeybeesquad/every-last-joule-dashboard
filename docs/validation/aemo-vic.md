...
- **TSO annual curtailment (latest published):** AEMO 2024 VIC wind+solar curtailment ~0.3 TWh
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_aemo-vic_*.parquet` (0 years)
