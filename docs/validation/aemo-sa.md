# Validation — South Australia (`aemo-sa`)
...
- **TSO annual curtailment (latest published):** AEMO 2024 SA wind+solar curtailment ~0.4 TWh (system-strength limited)
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_aemo-sa_*.parquet` (0 years)
