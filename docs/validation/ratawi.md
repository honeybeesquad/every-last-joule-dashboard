# Validation — Ratawi (flare) (`ratawi`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Ratawi, 0.3123 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.3123 bcm flared × 3.6925 TWh-e/bcm = 1.2 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_ratawi_*.parquet` (0 years)
