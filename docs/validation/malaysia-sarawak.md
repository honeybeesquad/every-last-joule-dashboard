# Validation — Sarawak Energy (`malaysia-sarawak`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `malaysia-sarawak`
- **Country:** MYS
- **Tier:** estimated
- **Kind:** hydro
- **Source:** Sarawak Energy — not Peninsular GSO/TNB. No time series wired. Waste unpublished.
- **Source URL:** [https://www.sarawakenergy.com/](https://www.sarawakenergy.com/)
...
- Backfill archive: `data/historical/backfill/*_malaysia-sarawak_*.parquet` (0 years)
