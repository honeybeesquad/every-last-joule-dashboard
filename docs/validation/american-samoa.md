# Validation — American Samoa (`american-samoa`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `american-samoa`
- **Country:** ASM
- **Tier:** estimated
- **Kind:** solar
- **Source:** ASPA annual reports. Grid present, ops unpublished.
- **Source URL:** [https://www.aspower.com/](https://www.aspower.com/)
...
- Backfill archive: `data/historical/backfill/*_american-samoa_*.parquet` (0 years)
