# Validation — Norway NO1 Wind (Oslo) (`norway-no1-wind`)

Last updated: 2026-06-21 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `norway-no1-wind`
- **Country:** NOR
- **Tier:** live
- **Kind:** wind
- **Source:** ENTSO-E NO1 wind (load-centre)
...
- Backfill archive: `data/historical/backfill/*_norway-no1-wind_*.parquet` (0 years)
