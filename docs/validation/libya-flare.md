# Validation — Libya (flare) (`libya-flare`)

Last updated: 2026-06-17 · GGFR per-flare-site split · T2 flare

## Source

- **Region id:** `libya-flare`
- **Country:** LBY
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Libya national, 6.2751 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 6.2751 bcm flared × 3.6925 TWh-e/bcm = 23.2 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_libya-flare_*.parquet` (0 years)
