...
- **Loader:** [`azps.json.ts`](../../src/data/azps.json.ts)
- **Structural gap:** no

## Calibration

- **Rate:** 2.0% of EIA-930 solar generation (conservative first-order anchor).
- **Anchor basis:** APS IRP 2023; EIA-930 Southwest solar duck-curve; Ember.
...
- Loader source: [`azps.json.ts`](../../src/data/azps.json.ts)
