...
- **Tier:** estimated
- **Kind:** wind
- **Source:** Ember China subnational generation (trailing 12mo) × NEA 2024 curtailment rate 3.6% (utilisation 96.4%); refreshed anchor, T3-modelled shape
...
- Backfill archive: `data/historical/backfill/*_china-shandong-wind_*.parquet` (0 years)
