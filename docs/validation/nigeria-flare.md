# Validation — Nigeria (flare) (`nigeria-flare`)

Last updated: 2026-06-17 · GGFR per-flare-site split · T2 flare

## Source

- **Region id:** `nigeria-flare`
- **Country:** NGA
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Nigeria national, 6.4796 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 6.4796 bcm flared × 3.6925 TWh-e/bcm = 23.9 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_nigeria-flare_*.parquet` (0 years)
