# Validation — Alaska Railbelt (`alaska-railbelt`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `alaska-railbelt`
- **Country:** USA
- **Tier:** estimated
- **Kind:** mixed
- **Source:** Chugach/MEA/GVEA/HEA isolated Railbelt. No public hourly series. Grid present, ops unpublished.
- **Source URL:** [https://rca.alaska.gov/](https://rca.alaska.gov/)
...
- Backfill archive: `data/historical/backfill/*_alaska-railbelt_*.parquet` (0 years)
