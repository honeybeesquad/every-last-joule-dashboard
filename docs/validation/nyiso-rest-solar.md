# Validation — NYISO (rest) Solar (`nyiso-rest-solar`)

Last updated: 2026-06-17 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `nyiso-rest-solar`
- **Country:** USA
- **Tier:** live
- **Kind:** solar
- **Source:** EIA NYISO solar (ex-Zones D/E)
...
- Backfill archive: `data/historical/backfill/*_nyiso-rest-solar_*.parquet` (0 years)
