...
- **Region id:** `china-hubei`
- **Country:** CHN
- **Tier:** static
- **Kind:** mixed
- **Source:** NEA 2024 provincial RE monitoring bulletin — mixed solar+wind+hydro curtailment ~1.5 TWh/yr (Three Gorges basin; missed RE consumption target)
...
- **Loader:** [`china-hubei.json.ts`](../../src/data/china-hubei.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-hubei.json.ts`](../../src/data/china-hubei.json.ts)
- Backfill archive: `data/historical/backfill/*_china-hubei_*.parquet` (0 years)
