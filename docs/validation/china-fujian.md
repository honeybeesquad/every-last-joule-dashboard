...
- Loader source: [`china-fujian.json.ts`](../../src/data/china-fujian.json.ts)
- Backfill archive: `data/historical/backfill/*_china-fujian_*.parquet` (0 years)
