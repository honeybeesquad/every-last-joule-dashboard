# Validation — Puerto Rico Solar (`puerto-rico-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `puerto-rico-solar`
- **Country:** PRI
- **Tier:** estimated
- **Kind:** solar
- **Source:** PREPA operationdata.prepa.pr.gov dataSource.js (utility-scale PPOA solar SiteTotal MW; abed NordVPN relay CSV). Waste unpublished — no curtailment column. EIA-930 has no PR BA. Not T1a.
...
- Backfill archive: `data/historical/backfill/*_puerto-rico-solar_*.parquet` (0 years)
