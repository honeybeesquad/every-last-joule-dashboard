# Validation — Denmark DK2 Solar (`denmark-east-solar`)

Last updated: 2026-06-21 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `denmark-east-solar`
- **Country:** DNK
- **Tier:** live
- **Kind:** solar
- **Source:** Energinet DK2 solar (25% share)
...
- Backfill archive: `data/historical/backfill/*_denmark-east-solar_*.parquet` (0 years)
