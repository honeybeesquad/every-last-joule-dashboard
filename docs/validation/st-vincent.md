# Validation — St Vincent (`st-vincent`)

Last updated: 2026-06-07 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `st-vincent`
- **Country:** VCT
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / VINLEC (~3 MW PV + hydro + diesel)
...
- Backfill archive: `data/historical/backfill/*_st-vincent_*.parquet` (0 years)
