...
- **Tier:** estimated
- **Kind:** solar
- **Source:** GPA annual reports. Grid present, ops unpublished.
- **Source URL:** [https://www.guampowerauthority.com/](https://www.guampowerauthority.com/)
...
- Backfill archive: `data/historical/backfill/*_guam_*.parquet` (0 years)
