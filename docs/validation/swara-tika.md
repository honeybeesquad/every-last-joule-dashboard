# Validation — Swara Tika (flare) (`swara-tika`)

Last updated: 2026-06-17 · GGFR per-flare-site split · T2 flare

## Source

- **Region id:** `swara-tika`
- **Country:** IRQ
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Swara Tika, 0.3122 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.3122 bcm flared × 3.6925 TWh-e/bcm = 1.2 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_swara-tika_*.parquet` (0 years)
