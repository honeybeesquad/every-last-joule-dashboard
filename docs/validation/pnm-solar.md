# Validation — Public Service New Mexico Solar (`pnm-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 PNM generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_pnm-solar_*.parquet` (0 years)
