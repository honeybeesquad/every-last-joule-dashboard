# Validation — Latvia Solar (`latvia-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `latvia-solar`
- **Country:** LVA
- **Tier:** estimated
- **Kind:** solar
- **Source:** AST ENTSO-E A75 solar generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_latvia-solar_*.parquet` (0 years)
