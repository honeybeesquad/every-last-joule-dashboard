# Validation — Afghanistan (`afghanistan`)

Last updated: 2026-05-05 · Phase 4-A completionist Tier A

## Source

- **Region id:** `afghanistan`
- **Country:** AFG
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / DABS (~150 MW solar capacity); modelled curtailment ~2% per regional default
...
|--------|-------|---------|
| IRENA RCS 2025 | ~150 MW solar | 2024 |
