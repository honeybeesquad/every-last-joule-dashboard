# Validation — Palestine (`palestine`)

Last updated: 2026-05-06 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2
...
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / Palestinian Energy Authority 2024
...
- Backfill archive: `data/historical/backfill/*_palestine_*.parquet` (0 years)
