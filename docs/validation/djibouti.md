...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / EDD (~15 MW solar; geothermal in development)
...
- Backfill archive: `data/historical/backfill/*_djibouti_*.parquet` (0 years)
