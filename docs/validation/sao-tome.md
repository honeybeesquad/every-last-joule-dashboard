# Validation — São Tomé & Príncipe (`sao-tome`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / EMAE (~3 MW PV + diesel + hydro)
...
- Backfill archive: `data/historical/backfill/*_sao-tome_*.parquet` (0 years)
