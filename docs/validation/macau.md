...
- **Tier:** estimated
- **Kind:** solar
- **Source:** CEM Macau — not China CSG. No hourly. Waste unpublished.
- **Source URL:** [https://www.cem-macau.com/](https://www.cem-macau.com/)
...
- Backfill archive: `data/historical/backfill/*_macau_*.parquet` (0 years)
