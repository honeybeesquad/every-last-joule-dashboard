...
- **Tier:** static
- **Kind:** mixed
- **Source:** IRENA RCS 2025 / REGIDESO (~30 MW hydro + emerging solar)
...
- Backfill archive: `data/historical/backfill/*_burundi_*.parquet` (0 years)
