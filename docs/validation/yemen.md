...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / PC (wartime distributed-PV boom; estimates only; conflict-affected)
...
- Backfill archive: `data/historical/backfill/*_yemen_*.parquet` (0 years)
