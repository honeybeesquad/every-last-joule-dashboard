...
_No backfill and no wind-only TSO curtailment anchor. Region relies on recent Facility SCADA wind generation and the SWIS aggregate 8% curtailment-rate calibration._
