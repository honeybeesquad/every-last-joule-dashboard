# Validation — Southwestern Power Administration Solar (`spa-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 SPA generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_spa-solar_*.parquet` (0 years)
