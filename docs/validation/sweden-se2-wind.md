# Validation — Sweden SE2 Wind (`sweden-se2-wind`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `sweden-se2-wind`
- **Country:** SWE
- **Tier:** estimated
- **Kind:** wind
- **Source:** Svenska kraftnät SE2 A75 generation (real SE2 EIC). Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_sweden-se2-wind_*.parquet` (0 years)
