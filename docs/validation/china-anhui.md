...
- **Region id:** `china-anhui`
- **Country:** CHN
- **Tier:** static
- **Kind:** solar
- **Source:** NEA 2024 provincial RE monitoring bulletin — solar curtailment ~2.1 TWh/yr
...
- **Loader:** [`china-anhui.json.ts`](../../src/data/china-anhui.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-anhui.json.ts`](../../src/data/china-anhui.json.ts)
- Backfill archive: `data/historical/backfill/*_china-anhui_*.parquet` (0 years)
