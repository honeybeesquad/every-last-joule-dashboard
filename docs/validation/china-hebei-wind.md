...
- **Tier:** estimated
- **Kind:** wind
- **Source:** NEA 2024 provincial RE monitoring bulletin — wind curtailment ~2.0 TWh/yr (north China wind corridor, Zhangjiakou transmission bottleneck)
...
- Backfill archive: `data/historical/backfill/*_china-hebei-wind_*.parquet` (0 years)
