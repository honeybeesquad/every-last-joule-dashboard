# Validation — Hong Kong CLP (`hong-kong-clp`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `hong-kong-clp`
- **Country:** HKG
- **Tier:** estimated
- **Kind:** solar
- **Source:** CLP — not China SGCC. Cloudflare/no hourly. Waste unpublished.
- **Source URL:** [https://www.clp.com.hk/](https://www.clp.com.hk/)
...
- Backfill archive: `data/historical/backfill/*_hong-kong-clp_*.parquet` (0 years)
