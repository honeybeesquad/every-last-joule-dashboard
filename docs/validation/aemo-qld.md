# Validation — Queensland (`aemo-qld`)
...
- **TSO annual curtailment (latest published):** AEMO 2024 QLD wind+solar curtailment ~0.8 TWh (PV congestion on North QLD)
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_aemo-qld_*.parquet` (0 years)
