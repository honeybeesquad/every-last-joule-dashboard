...
- **Region id:** `nt-pilbara`
- **Country:** AUS
- **Tier:** static
- **Kind:** solar
- **Source:** Horizon/Pilbara fallback
- **Source URL:** [https://www.horizonpower.com.au/](https://www.horizonpower.com.au/)
- **Loader:** [`nt-pilbara.json.ts`](../../src/data/nt-pilbara.json.ts)
- **Structural gap:** yes
...
- Loader source: [`nt-pilbara.json.ts`](../../src/data/nt-pilbara.json.ts)
- Backfill archive: `data/historical/backfill/*_nt-pilbara_*.parquet` (0 years)
