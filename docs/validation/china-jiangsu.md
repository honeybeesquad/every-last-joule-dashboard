...
- **Region id:** `china-jiangsu`
- **Country:** CHN
- **Tier:** static
- **Kind:** mixed
- **Source:** NEA 2024 provincial RE monitoring bulletin — offshore wind + solar curtailment ~2.8 TWh/yr
...
- **Loader:** [`china-jiangsu.json.ts`](../../src/data/china-jiangsu.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-jiangsu.json.ts`](../../src/data/china-jiangsu.json.ts)
- Backfill archive: `data/historical/backfill/*_china-jiangsu_*.parquet` (0 years)
