...
- **Tier:** static
- **Kind:** hydro
- **Source:** IRENA RCS 2025 / EFL Fiji (Monasavu hydro + ~5 MW PV; Pacific island)
...
- Backfill archive: `data/historical/backfill/*_fiji_*.parquet` (0 years)
