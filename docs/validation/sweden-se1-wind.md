# Validation — Sweden SE1 Wind (`sweden-se1-wind`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `sweden-se1-wind`
- **Country:** SWE
- **Tier:** estimated
- **Kind:** wind
- **Source:** Svenska kraftnät SE1 A75 generation. sweden-north is a separate existing row (SE3 EIC). Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_sweden-se1-wind_*.parquet` (0 years)
