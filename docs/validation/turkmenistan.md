# Validation — Turkmenistan (`turkmenistan`)

Last updated: 2026-05-05 · Phase 4-A completionist Tier A

## Source

- **Region id:** `turkmenistan`
- **Country:** TKM
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / TDS (recent solar tenders; ~10-100 MW); modelled curtailment ~2% per regional default
...
|--------|-------|---------|
| IRENA RCS 2025 | ~10-100 MW solar | 2024 |
