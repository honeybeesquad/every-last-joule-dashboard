...
- **Tier:** estimated
- **Kind:** wind
- **Source:** EIA-930 TVA generation. Waste unpublished — Sustainability Report is not a measured series.
...
- Backfill archive: `data/historical/backfill/*_tva-wind_*.parquet` (0 years)
