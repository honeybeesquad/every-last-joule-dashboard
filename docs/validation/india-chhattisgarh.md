...
- **Tier:** estimated
- **Kind:** solar
- **Source:** CEA gen-re.cea.gov.in daily Excel — Chhattisgarh emerging solar. T3-modelled fallback calibrated to Ember India 2024 (~0.08 TWh/yr solar curtailment). Loader reads committed CEA CSV when available.
- **Source URL:** [https://gen-re.cea.gov.in/](https://gen-re.cea.gov.in/)
- **Loader:** [`india-chhattisgarh.json.ts`](../../src/data/india-chhattisgarh.json.ts)
- **Structural gap:** no
...
- Loader source: [`india-chhattisgarh.json.ts`](../../src/data/india-chhattisgarh.json.ts)
- Backfill archive: `data/historical/backfill/*_india-chhattisgarh_*.parquet` (0 years)
