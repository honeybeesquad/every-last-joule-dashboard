# Validation — Belgium Wind (`belgium-wind`)

Last updated: 2026-05-04 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `belgium-wind`
- **Country:** BEL
- **Tier:** live
- **Kind:** wind
- **Source:** Elia Open Data wind (B18+B19)
...
- Backfill archive: `data/historical/backfill/*_belgium-wind_*.parquet` (0 years)
