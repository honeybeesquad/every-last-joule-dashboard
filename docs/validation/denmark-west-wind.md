# Validation — Denmark DK1 Wind (`denmark-west-wind`)

Last updated: 2026-06-21 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `denmark-west-wind`
- **Country:** DNK
- **Tier:** live
- **Kind:** wind
- **Source:** Energinet DK1 wind (75% share)
...
- Backfill archive: `data/historical/backfill/*_denmark-west-wind_*.parquet` (0 years)
