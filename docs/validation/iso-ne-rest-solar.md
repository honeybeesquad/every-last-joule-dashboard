# Validation — ISO-NE (rest) Solar (`iso-ne-rest-solar`)

Last updated: 2026-06-18 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `iso-ne-rest-solar`
- **Country:** USA
- **Tier:** live
- **Kind:** solar
- **Source:** EIA ISO-NE solar (ex-ME/VT)
...
- Backfill archive: `data/historical/backfill/*_iso-ne-rest-solar_*.parquet` (0 years)
