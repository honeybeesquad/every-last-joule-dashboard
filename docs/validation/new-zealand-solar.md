# Validation — New Zealand Solar (`new-zealand-solar`)

Last updated: 2026-06-18 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `new-zealand-solar`
- **Country:** NZL
- **Tier:** live
- **Kind:** solar
- **Source:** EMI DispatchNodalPricesAndVolumes ≤$0/MWh nodal price signal
...
- Backfill archive: `data/historical/backfill/*_new-zealand-solar_*.parquet` (0 years)
