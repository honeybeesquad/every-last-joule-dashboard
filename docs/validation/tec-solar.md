# Validation — Tampa Electric Solar (`tec-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 TEC generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_tec-solar_*.parquet` (0 years)
