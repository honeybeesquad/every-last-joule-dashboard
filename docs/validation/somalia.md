...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / MOEP (fragmented grid; diesel + emerging PV)
...
- Backfill archive: `data/historical/backfill/*_somalia_*.parquet` (0 years)
