# Validation — Belarus Solar (`belarus-solar`)

Last updated: 2026-05-05 · Phase 4-A completionist Tier A

## Source

- **Region id:** `belarus-solar`
- **Country:** BLR
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / Belenergo annual report (~90 MW solar, growing residential + utility PV); modelled curtailment ~2% per regional default
...
|--------|-------|---------|
| IRENA RCS 2025 | ~90 MW solar | 2024 |
