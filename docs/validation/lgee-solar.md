# Validation — LG&E/KU Solar (`lgee-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `lgee-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 LGEE generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_lgee-solar_*.parquet` (0 years)
