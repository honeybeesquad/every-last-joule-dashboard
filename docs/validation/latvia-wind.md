# Validation — Latvia Wind (`latvia-wind`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `latvia-wind`
- **Country:** LVA
- **Tier:** estimated
- **Kind:** wind
- **Source:** AST ENTSO-E A75 wind generation. Waste unpublished — prior live zeros were unverified.
...
- Backfill archive: `data/historical/backfill/*_latvia-wind_*.parquet` (0 years)
