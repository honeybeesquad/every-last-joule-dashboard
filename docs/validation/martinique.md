# Validation — Martinique (`martinique`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `martinique`
- **Country:** MTQ
- **Tier:** estimated
- **Kind:** solar
- **Source:** EDF SEI Martinique. No hourly series wired. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_martinique_*.parquet` (0 years)
