# Validation — New Brunswick (`new-brunswick`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `new-brunswick`
- **Country:** CAN
- **Tier:** estimated
- **Kind:** mixed
- **Source:** NB Power. No hourly TSO series wired. Grid present, ops unpublished.
- **Source URL:** [https://www.nbpower.com/](https://www.nbpower.com/)
...
- Backfill archive: `data/historical/backfill/*_new-brunswick_*.parquet` (0 years)
