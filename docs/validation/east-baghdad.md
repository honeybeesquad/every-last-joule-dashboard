# Validation — East Baghdad (flare) (`east-baghdad`)

Last updated: 2026-06-17 · GGFR per-flare-site split · T2 flare

## Source

- **Region id:** `east-baghdad`
- **Country:** IRQ
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (East Baghdad, 0.3498 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.3498 bcm flared × 3.6925 TWh-e/bcm = 1.3 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_east-baghdad_*.parquet` (0 years)
