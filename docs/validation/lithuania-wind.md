# Validation — Lithuania Wind (`lithuania-wind`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `lithuania-wind`
- **Country:** LTU
- **Tier:** estimated
- **Kind:** wind
- **Source:** Litgrid ENTSO-E A75 wind generation. Waste unpublished — prior live zeros were unverified.
...
- Backfill archive: `data/historical/backfill/*_lithuania-wind_*.parquet` (0 years)
