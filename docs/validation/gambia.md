...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / NAWEC (~10 MW PV + diesel; small West African grid)
...
- Backfill archive: `data/historical/backfill/*_gambia_*.parquet` (0 years)
