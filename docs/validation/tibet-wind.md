# Validation — Tibet Wind (`tibet-wind`)

Last updated: 2026-06-18 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `tibet-wind`
- **Country:** CHN
- **Tier:** estimated
- **Kind:** wind
- **Source:** NEA 2024 provincial RE monitoring bulletin — wind curtailment (~0.2 TWh/yr, wind utilisation 83.0%, small grid)
...
- Backfill archive: `data/historical/backfill/*_tibet-wind_*.parquet` (0 years)
