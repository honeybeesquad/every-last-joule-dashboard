# Validation — Duke Energy Progress East Solar (`cple-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `cple-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 CPLE generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_cple-solar_*.parquet` (0 years)
