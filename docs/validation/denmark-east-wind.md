# Validation — Denmark DK2 Wind (`denmark-east-wind`)

Last updated: 2026-06-21 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `denmark-east-wind`
- **Country:** DNK
- **Tier:** live
- **Kind:** wind
- **Source:** Energinet DK2 wind (25% share)
...
- Backfill archive: `data/historical/backfill/*_denmark-east-wind_*.parquet` (0 years)
