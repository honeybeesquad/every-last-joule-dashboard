# Validation — ISO-NE (rest) Wind (`iso-ne-rest-wind`)

Last updated: 2026-05-05 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `iso-ne-rest-wind`
- **Country:** USA
- **Tier:** live
- **Kind:** wind
- **Source:** EIA ISO-NE wind (ex-ME/VT)
...
- Backfill archive: `data/historical/backfill/*_iso-ne-rest-wind_*.parquet` (0 years)
