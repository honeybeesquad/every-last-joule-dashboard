# Validation — S. Jafurah Gas Plant (flare) (`s-jafurah`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Southern Jafurah Gas Plant, 0.1151 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.1151 bcm flared × 3.6925 TWh-e/bcm = 0.4 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_s-jafurah_*.parquet` (0 years)
