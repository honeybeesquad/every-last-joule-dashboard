...
- **Tier:** estimated
- **Kind:** hydro
- **Source:** IRENA RCS 2025 / BPC (hydro-dominant; ~1.6 GW; seasonal spillage)
...
- Backfill archive: `data/historical/backfill/*_bhutan_*.parquet` (0 years)
