# Validation — Kosovo Solar (`kosovo-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `kosovo-solar`
- **Country:** XKX
- **Tier:** estimated
- **Kind:** solar
- **Source:** KOSTT A75 solar generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_kosovo-solar_*.parquet` (0 years)
