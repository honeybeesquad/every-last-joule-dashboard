# Validation — Faihaa (flare) (`faihaa`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Faihaa, 0.2796 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.2796 bcm flared × 3.6925 TWh-e/bcm = 1.0 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_faihaa_*.parquet` (0 years)
