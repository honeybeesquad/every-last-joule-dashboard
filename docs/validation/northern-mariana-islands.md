# Validation — Northern Mariana Islands (`northern-mariana-islands`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `northern-mariana-islands`
- **Country:** MNP
- **Tier:** estimated
- **Kind:** solar
- **Source:** CNMI CUC annual reports. Grid present, ops unpublished.
- **Source URL:** [https://www.cucgov.org/](https://www.cucgov.org/)
...
- Backfill archive: `data/historical/backfill/*_northern-mariana-islands_*.parquet` (0 years)
