# Validation — Wallis and Futuna (`wallis-and-futuna`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `wallis-and-futuna`
- **Country:** WLF
- **Tier:** estimated
- **Kind:** solar
- **Source:** EEWF. No hourly series wired. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_wallis-and-futuna_*.parquet` (0 years)
