...
- **Tier:** live
- **Kind:** solar
- **Source:** COES-SINAC live solar generation x 2% curtailment calibration (vertimiento anchor ~0.8 TWh/yr)
...
- **Ember annual:** -
- **IRENA annual:** -
- **Other:** Solar child is split from the COES generation-by-fuel stream and aggregate vertimiento calibration.
