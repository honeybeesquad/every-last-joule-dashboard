...
- **Tier:** static
- **Kind:** mixed
- **Source:** Manitoba Hydro fallback
- **Source URL:** [https://www.hydro.mb.ca/](https://www.hydro.mb.ca/)
- **Loader:** [`manitoba.json.ts`](../../src/data/manitoba.json.ts)
- **Structural gap:** yes
...
- **TSO annual curtailment (latest published):** Manitoba Hydro 2024 curtailment minimal (hydro baseload)
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Loader source: [`manitoba.json.ts`](../../src/data/manitoba.json.ts)
- Backfill archive: `data/historical/backfill/*_manitoba_*.parquet` (0 years)
