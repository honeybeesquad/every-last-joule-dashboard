...
- **Tier:** estimated
- **Kind:** hydro
- **Source:** IRENA RCS 2025 / EDG Guinea (Garafiri + Kaleta + Souapiti hydro; hydro-dominant)
...
- Backfill archive: `data/historical/backfill/*_guinea_*.parquet` (0 years)
