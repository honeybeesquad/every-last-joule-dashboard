...
- **Region id:** `china-guizhou`
- **Country:** CHN
- **Tier:** static
- **Kind:** mixed
- **Source:** NEA 2024 provincial RE monitoring bulletin — mixed solar+hydro curtailment ~0.25 TWh/yr
...
- **Loader:** [`china-guizhou.json.ts`](../../src/data/china-guizhou.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-guizhou.json.ts`](../../src/data/china-guizhou.json.ts)
- Backfill archive: `data/historical/backfill/*_china-guizhou_*.parquet` (0 years)
