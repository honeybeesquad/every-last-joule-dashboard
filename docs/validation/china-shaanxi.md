...
- **Region id:** `china-shaanxi`
- **Country:** CHN
- **Tier:** static
- **Kind:** solar
- **Source:** NEA 2024 provincial RE monitoring bulletin — solar curtailment ~1.1 TWh/yr (Guanzhong basin PV)
...
- **Loader:** [`china-shaanxi.json.ts`](../../src/data/china-shaanxi.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-shaanxi.json.ts`](../../src/data/china-shaanxi.json.ts)
- Backfill archive: `data/historical/backfill/*_china-shaanxi_*.parquet` (0 years)
