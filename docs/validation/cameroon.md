...
- **Tier:** static
- **Kind:** hydro
- **Source:** IRENA Cameroon 2024 (ENEO/SONATREL; mostly hydro)
- **Source URL:** [https://eneo.cm/](https://eneo.cm/)
...
- Backfill archive: `data/historical/backfill/*_cameroon_*.parquet` (0 years)
