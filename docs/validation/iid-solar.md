# Validation — Imperial Irrigation District Solar (`iid-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 IID generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_iid-solar_*.parquet` (0 years)
