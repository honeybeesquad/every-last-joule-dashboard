...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Wafra, 0.2037 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.2037 bcm flared × 3.6925 TWh-e/bcm = 0.8 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_wafra_*.parquet` (0 years)
