# Validation — West Qurna 1 (flare) (`west-qurna-1`)

Last updated: 2026-06-17 · GGFR per-flare-site split · T2 flare

## Source

- **Region id:** `west-qurna-1`
- **Country:** IRQ
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (West Qurna 1, 0.8724 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.8724 bcm flared × 3.6925 TWh-e/bcm = 3.2 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_west-qurna-1_*.parquet` (0 years)
