...
- **Loader:** [`china-henan.json.ts`](../../src/data/china-henan.json.ts)
- **Structural gap:** no
...
- Loader source: [`china-henan.json.ts`](../../src/data/china-henan.json.ts)
- Backfill archive: `data/historical/backfill/*_china-henan_*.parquet` (0 years)
