...
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / Monaco (~5 MW rooftop PV; part of French grid)
...
- Backfill archive: `data/historical/backfill/*_monaco_*.parquet` (0 years)
