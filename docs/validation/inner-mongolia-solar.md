...
- **Region id:** `inner-mongolia-solar`
- **Country:** CHN
- **Tier:** estimated
- **Kind:** solar
- **Source:** Ember China subnational generation (trailing 12mo) × NEA 2024 curtailment rate 5.3% (utilisation 94.7%); refreshed anchor, T3-modelled shape
...
- Backfill archive: `data/historical/backfill/*_inner-mongolia-solar_*.parquet` (0 years)
