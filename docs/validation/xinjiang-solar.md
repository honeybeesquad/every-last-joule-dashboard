# Validation — Xinjiang Solar (`xinjiang-solar`)

Last updated: 2026-08-20 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `xinjiang-solar`
- **Country:** CHN
- **Tier:** estimated
- **Kind:** solar
- **Source:** Ember China subnational generation (trailing 12mo) × NEA 2024 curtailment rate 7.8% (utilisation 92.2%); refreshed anchor, T3-modelled shape
...
- **Loader:** [`xinjiang.json.ts`](../../src/data/xinjiang.json.ts)
- **Structural gap:** no
...
- Loader source: [`xinjiang.json.ts`](../../src/data/xinjiang.json.ts)
- Backfill archive: `data/historical/backfill/*_xinjiang-solar_*.parquet` (0 years)
