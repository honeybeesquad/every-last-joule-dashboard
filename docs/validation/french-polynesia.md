# Validation — French Polynesia (`french-polynesia`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `french-polynesia`
- **Country:** PYF
- **Tier:** estimated
- **Kind:** solar
- **Source:** EDT. No hourly series wired. Waste unpublished.
- **Source URL:** [https://www.edt.pf/](https://www.edt.pf/)
...
- Backfill archive: `data/historical/backfill/*_french-polynesia_*.parquet` (0 years)
