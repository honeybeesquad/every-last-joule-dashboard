...
- **Region id:** `china-chongqing`
- **Country:** CHN
- **Tier:** static
- **Kind:** mixed
- **Source:** NEA 2024 provincial RE monitoring bulletin — mixed hydro+solar curtailment ~0.22 TWh/yr (Yangtze basin)
...
- **Loader:** [`china-chongqing.json.ts`](../../src/data/china-chongqing.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-chongqing.json.ts`](../../src/data/china-chongqing.json.ts)
- Backfill archive: `data/historical/backfill/*_china-chongqing_*.parquet` (0 years)
