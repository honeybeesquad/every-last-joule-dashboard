...
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA Bolivia 2024 (hydro+gas dominated grid; solar+wind ~3% of mix; CNDC PDF reports)
- **Source URL:** [https://www.cndc.bo/](https://www.cndc.bo/)
...
- Backfill archive: `data/historical/backfill/*_bolivia_*.parquet` (0 years)
