...
- **Region id:** `mozambique`
- **Country:** MOZ
- **Tier:** static
- **Kind:** hydro
- **Source:** IRENA Mozambique 2024 (EDM; Cahora Bassa hydro; SAPP)
- **Source URL:** [https://www.edm.co.mz/](https://www.edm.co.mz/)
...
- Backfill archive: `data/historical/backfill/*_mozambique_*.parquet` (0 years)
