# Validation — Associated Electric Cooperative Solar (`aeci-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `aeci-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 AECI generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_aeci-solar_*.parquet` (0 years)
