# Validation — El Paso Electric Solar (`epe-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 EPE generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_epe-solar_*.parquet` (0 years)
