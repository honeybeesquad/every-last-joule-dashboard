# Validation — SESB Sabah (`malaysia-sabah`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `malaysia-sabah`
- **Country:** MYS
- **Tier:** estimated
- **Kind:** solar
- **Source:** SESB Sabah — not Peninsular GSO/TNB. No time series wired. Waste unpublished.
- **Source URL:** [https://www.sesb.com.my/](https://www.sesb.com.my/)
...
- Backfill archive: `data/historical/backfill/*_malaysia-sabah_*.parquet` (0 years)
