...
- **Tier:** estimated
- **Kind:** hydro
- **Source:** IRENA RCS 2025 / LEWA (Muela HPP 72 MW; hydro-dominant)
...
- Backfill archive: `data/historical/backfill/*_lesotho_*.parquet` (0 years)
