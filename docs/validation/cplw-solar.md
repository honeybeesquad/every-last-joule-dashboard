# Validation — Duke Energy Progress West Solar (`cplw-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `cplw-solar`
- **Country:** USA
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 CPLW generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_cplw-solar_*.parquet` (0 years)
