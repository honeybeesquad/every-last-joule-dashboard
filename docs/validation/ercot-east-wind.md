# Validation — ERCOT East Wind (`ercot-east-wind`)

Last updated: 2026-06-17 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `ercot-east-wind`
- **Country:** USA
- **Tier:** live
- **Kind:** wind
- **Source:** EIA ERCO wind
...
- Backfill archive: `data/historical/backfill/*_ercot-east-wind_*.parquet` (0 years)
