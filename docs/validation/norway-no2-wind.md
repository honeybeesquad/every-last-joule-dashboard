# Validation — Norway NO2 Wind (Kristiansand) (`norway-no2-wind`)
...
- **Tier:** live
- **Kind:** wind
- **Source:** ENTSO-E NO2 offshore wind (NorNed/NordLink/NSL cable zone)
...
- Backfill archive: `data/historical/backfill/*_norway-no2-wind_*.parquet` (0 years)
