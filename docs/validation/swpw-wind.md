# Validation — SPP West Wind (`swpw-wind`)
...
- **Tier:** estimated
- **Kind:** wind
- **Source:** EIA-930 SWPW (successor to retired WACM). Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_swpw-wind_*.parquet` (0 years)
