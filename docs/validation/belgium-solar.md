# Validation — Belgium (Solar) (`belgium-solar`)

Last updated: 2026-04-27 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `belgium-solar`
- **Country:** BEL
- **Tier:** live
- **Kind:** solar
- **Source:** Elia Open Data (solar only)
...
- Backfill archive: `data/historical/backfill/*_belgium-solar_*.parquet` (0 years)
