# Validation — Duke Energy Florida Solar (`fpc-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 FPC generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_fpc-solar_*.parquet` (0 years)
