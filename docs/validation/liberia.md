...
- **Tier:** estimated
- **Kind:** hydro
- **Source:** IRENA RCS 2025 / LEC (Mt Coffee hydro 88 MW + diesel; WAPP)
...
- Backfill archive: `data/historical/backfill/*_liberia_*.parquet` (0 years)
