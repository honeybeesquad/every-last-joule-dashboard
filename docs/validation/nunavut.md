...
- **Tier:** estimated
- **Kind:** mixed
- **Source:** Qulliq Energy isolated diesel. VRE waste unpublished.
- **Source URL:** [https://www.qec.nu.ca/](https://www.qec.nu.ca/)
...
- Backfill archive: `data/historical/backfill/*_nunavut_*.parquet` (0 years)
