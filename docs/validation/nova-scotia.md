# Validation — Nova Scotia (`nova-scotia`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `nova-scotia`
- **Country:** CAN
- **Tier:** estimated
- **Kind:** wind
- **Source:** NS Power. No hourly TSO series wired. Grid present, ops unpublished.
- **Source URL:** [https://www.nspower.ca/](https://www.nspower.ca/)
...
- Backfill archive: `data/historical/backfill/*_nova-scotia_*.parquet` (0 years)
