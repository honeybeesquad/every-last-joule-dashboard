# Validation — Majnoon (flare) (`majnoon`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Majnoon, 0.6035 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.6035 bcm flared × 3.6925 TWh-e/bcm = 2.2 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_majnoon_*.parquet` (0 years)
