# Validation — Bosnia Solar (`bosnia-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `bosnia-solar`
- **Country:** BIH
- **Tier:** estimated
- **Kind:** solar
- **Source:** NOS BiH A75 solar generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_bosnia-solar_*.parquet` (0 years)
