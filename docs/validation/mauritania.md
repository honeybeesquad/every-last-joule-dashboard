...
- **Region id:** `mauritania`
- **Country:** MRT
- **Tier:** static
- **Kind:** wind
- **Source:** IRENA Mauritania 2024 (SOMELEC; Boulenouar wind 100 MW + Sheikh Zayed PV)
- **Source URL:** [https://somelec.mr/](https://somelec.mr/)
...
- Backfill archive: `data/historical/backfill/*_mauritania_*.parquet` (0 years)
