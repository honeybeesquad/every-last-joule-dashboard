# Validation — Florida Power & Light Solar (`fpl-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 FPL generation. Waste unpublished — FRCC/FPL publish no curtailment series.
...
- Backfill archive: `data/historical/backfill/*_fpl-solar_*.parquet` (0 years)
