# Validation — Xinjiang Wind (`xinjiang-wind`)

Last updated: 2026-08-20 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `xinjiang-wind`
- **Country:** CHN
- **Tier:** estimated
- **Kind:** wind
- **Source:** Ember China subnational generation (trailing 12mo) × NEA 2024 curtailment rate 6.6% (utilisation 93.4%); refreshed anchor, T3-modelled shape
...
- Backfill archive: `data/historical/backfill/*_xinjiang-wind_*.parquet` (0 years)
