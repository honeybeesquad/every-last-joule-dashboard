# Validation — Norway NO3 Hydro (Trondheim) (`norway-no3-hydro`)

Last updated: 2026-06-06 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `norway-no3-hydro`
- **Country:** NOR
- **Tier:** live
- **Kind:** hydro
- **Source:** ENTSO-E NO3 hydro
...
- Backfill archive: `data/historical/backfill/*_norway-no3-hydro_*.parquet` (0 years)
