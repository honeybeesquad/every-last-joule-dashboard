# Validation — Kirkuk Avanah (flare) (`kirkuk`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Kirkuk (Avanah Dome), 0.2853 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.2853 bcm flared × 3.6925 TWh-e/bcm = 1.1 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_kirkuk_*.parquet` (0 years)
