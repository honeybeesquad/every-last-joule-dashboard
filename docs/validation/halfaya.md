# Validation — Halfaya (flare) (`halfaya`)
...
- **Tier:** anchored
- **Kind:** flare
- **Source:** VIIRS + GGFR per-flare-site 2024 (Halfaya, 0.7357 bcm)
...
- **GGFR/GFMR per-site VIIRS (2024):** 0.7357 bcm flared × 3.6925 TWh-e/bcm = 2.7 TWh-e/yr
- **Ember annual:** —
- **IRENA annual:** —
- **Other:** —
...
- Backfill archive: `data/historical/backfill/*_halfaya_*.parquet` (0 years)
