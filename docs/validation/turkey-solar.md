# Validation — Turkey (solar) (`turkey-solar`)

Last updated: 2026-06-06 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `turkey-solar`
- **Country:** TUR
- **Tier:** live
- **Kind:** solar
- **Source:** EPIAS Transparency dashboard solar
...
- Backfill archive: `data/historical/backfill/*_turkey-solar_*.parquet` (0 years)
