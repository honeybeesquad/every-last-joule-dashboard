# Validation — Duke Energy Carolinas Solar (`duk-solar`)
...
- **Tier:** estimated
- **Kind:** solar
- **Source:** EIA-930 DUK generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_duk-solar_*.parquet` (0 years)
