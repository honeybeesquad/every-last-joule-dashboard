# Validation — Seychelles (`seychelles`)

Last updated: 2026-06-21 · Sprint: S1 + HB integration · Paper section: Technical Validation §4.2

## Source

- **Region id:** `seychelles`
- **Country:** SYC
- **Tier:** estimated
- **Kind:** solar
- **Source:** IRENA RCS 2025 / PUC (~5 MW PV + diesel + pumped hydro; island)
...
- Backfill archive: `data/historical/backfill/*_seychelles_*.parquet` (0 years)
