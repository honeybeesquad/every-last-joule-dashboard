# Validation — Guadeloupe (`guadeloupe`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `guadeloupe`
- **Country:** GLP
- **Tier:** estimated
- **Kind:** solar
- **Source:** EDF SEI Guadeloupe. No hourly series wired. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_guadeloupe_*.parquet` (0 years)
