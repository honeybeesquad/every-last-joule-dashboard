# Validation — Northwest Territories (`northwest-territories`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `northwest-territories`
- **Country:** CAN
- **Tier:** estimated
- **Kind:** hydro
- **Source:** NTPC isolated diesel/hydro. VRE waste unpublished.
- **Source URL:** [https://www.ntpc.com/](https://www.ntpc.com/)
...
- Backfill archive: `data/historical/backfill/*_northwest-territories_*.parquet` (0 years)
