...
- **Region id:** `trinidad-tobago`
- **Country:** TTO
- **Tier:** static
- **Kind:** flare
- **Source:** GGFR 2024 Trinidad offshore flares ~1 BCM (upstream offshore flare lifted onto T&TEC grid coverage)
- **Source URL:** [https://ttec.co.tt/](https://ttec.co.tt/)
...
- Backfill archive: `data/historical/backfill/*_trinidad-tobago_*.parquet` (0 years)
