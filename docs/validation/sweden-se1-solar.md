# Validation — Sweden SE1 Solar (`sweden-se1-solar`)

Last updated: 2026-09-20 · Sprint: TSO-grid completeness · Paper section: Technical Validation §4.2

## Source

- **Region id:** `sweden-se1-solar`
- **Country:** SWE
- **Tier:** estimated
- **Kind:** solar
- **Source:** Svenska kraftnät SE1 A75 generation. Waste unpublished.
...
- Backfill archive: `data/historical/backfill/*_sweden-se1-solar_*.parquet` (0 years)
