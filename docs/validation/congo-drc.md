...
- **Tier:** static
- **Kind:** hydro
- **Source:** IRENA DRC 2024 (SNEL; Inga hydro complex ~2.5 GW; SAPP)
- **Source URL:** [https://www.snel.cd/](https://www.snel.cd/)
...
- Backfill archive: `data/historical/backfill/*_congo-drc_*.parquet` (0 years)
