...
- **Tier:** static
- **Kind:** solar
- **Source:** IRENA RCS 2025 / PEO (sparse; conflict-affected grid; ~50 MW PV estimated); modelled curtailment ~2% per regional default
...
|--------|-------|---------|
| IRENA RCS 2025 | ~50 MW PV (estimated) | 2024 |
