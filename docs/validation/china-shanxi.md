...
- **Region id:** `china-shanxi`
- **Country:** CHN
- **Tier:** static
- **Kind:** mixed
- **Source:** NEA 2024 provincial RE monitoring bulletin — mixed wind+solar curtailment ~1.4 TWh/yr
...
- **Loader:** [`china-shanxi.json.ts`](../../src/data/china-shanxi.json.ts)
- **Structural gap:** yes
...
- Loader source: [`china-shanxi.json.ts`](../../src/data/china-shanxi.json.ts)
- Backfill archive: `data/historical/backfill/*_china-shanxi_*.parquet` (0 years)
