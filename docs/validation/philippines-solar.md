...
- **Rate source:** n/a — T3 provisional anchor, no calibration rate applied. Annual anchor from IRENA Philippines RE Statistics 2024 (~0.04 TWh/yr solar).
...
- Backfill archive: `data/historical/backfill/*_philippines-solar_*.parquet` (0 years)
