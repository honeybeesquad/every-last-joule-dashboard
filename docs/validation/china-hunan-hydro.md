...
- **Tier:** anchored
- **Kind:** hydro
- **Source:** NEA 2024 provincial RE monitoring bulletin — hydro curtailment (hydro 20% of ~1.9 TWh/yr)
...
- Backfill archive: `data/historical/backfill/*_china-hunan-hydro_*.parquet` (0 years)
