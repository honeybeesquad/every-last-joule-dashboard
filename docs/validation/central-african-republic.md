...
- **Region id:** `central-african-republic`
- **Country:** CAF
- **Tier:** estimated
- **Kind:** hydro
- **Source:** IRENA RCS 2025 / ENERCA (micro-hydro + diesel; very small grid)
...
- Backfill archive: `data/historical/backfill/*_central-african-republic_*.parquet` (0 years)
