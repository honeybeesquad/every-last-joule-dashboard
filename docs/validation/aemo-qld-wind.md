...
- **Region id:** `aemo-qld-wind`
- **Country:** AUS
- **Tier:** live
- **Kind:** wind
- **Source:** AEMO NEMWeb wind SEMIDISPATCHCAP (rest of state; named per-plant DUIDs split out separately to avoid double-counting)
...
- Backfill archive: `data/historical/backfill/*_aemo-qld-wind_*.parquet` (0 years)
