...
- **Last minted tag:** `v1.3.2` (Zenodo
  `10.5281/zenodo.20570864`) — 385 regions, includes flare.
  The records in this descriptor are **HEAD**: 459 regions,
  renewables only. No flare-free version DOI yet.
