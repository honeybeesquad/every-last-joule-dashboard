...
## Live HEAD vs archived deposit

| | Live HEAD | Last mint (v1.3.2) |
|---|---|---|
| Regions | **459** | 385 |
...
| Version DOI | none yet | `10.5281/zenodo.20570864` |

These drafts describe **HEAD**. `dataset/README.md`, `CITATION.cff`,
and `.zenodo.json` stay pinned to v1.3.2 and should not be silently
rewritten. A flare-free mint is a separate act.
...
| 5 | [`05-usage-notes.md`](05-usage-notes.md) | 500–1000 | HEAD load paths; v1.3.2 citation distinguished |
| 6 | [`06-code-availability.md`](06-code-availability.md) | 100–200 | HEAD vs v1.3.2 tag |
| — | [`figure-captions.md`](figure-captions.md) | n/a | HEAD counts; regen flagged |
...
Zenodo history (all minted cuts through v1.3.2 still include flare
or predate the 459-region roster): v1.0.0
`10.5281/zenodo.19835566` … v1.3.2 `10.5281/zenodo.20570864`.
Concept DOI `10.5281/zenodo.19835411` resolves to latest.
