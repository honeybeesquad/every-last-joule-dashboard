# World Coverage Audit Subagent — Europe-ENTSO-E

## Mission

You are auditing the world's electricity grid operators against the Every-Last-Joule project's tier model. Your scope is **Europe-ENTSO-E**. You will produce one CSV row per grid operator / bidding zone in your scope and write the result to `data/coverage-audit/2026-04-26-europe-entsoe.csv`.
...
## Your scope: All ENTSO-E member TSOs and bidding zones. Most are already documented in docs/methodology/entsoe-rates.md — your job is to transcribe that documentation into audit-CSV schema, NOT to re-research from scratch.
...
```bash
python3 scripts/validation/lint_coverage_audit.py data/coverage-audit/2026-04-26-europe-entsoe.csv
```
