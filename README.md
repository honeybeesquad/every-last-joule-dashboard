...
> Collins, S. (2026). _Every Last Joule: an hourly synthesis of renewable-electricity curtailment and associated-gas flaring across 384 regions._ Scientific Data (in review). Dataset version: v1.3.0 (Zenodo version DOI pinned in `dataset/CITATION.cff` on tag mint; concept DOI [10.5281/zenodo.19835411](https://doi.org/10.5281/zenodo.19835411) always resolves to latest).
