...
const STATIC_REGIONS: Record<string, StaticSpec> = {
  ...
  // Anchors: IRENA Country Statistics 2024, Ember country reports. All
  // ±40% T3-modelled (or T3 via flat-as-typical for hydro/mixed) per the
  // Pattern-D dispatch §3.
