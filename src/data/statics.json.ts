...
const STATIC_REGIONS: Record<string, StaticSpec> = {
  ...
  "n-norway": { annualTWh: 7, source: "Nord Pool system-price data (stranded N. Norway hydro)", reportDate: "2024" },
  atacama: { annualTWh: 5.9, source: "Coordinador Eléctrico Nacional / book research (+149% YoY 2024)", reportDate: "2024" },
  aemo: { annualTWh: 4.3, source: "WattClarity / AEMO QED Q3-Q4 2025 (economic + network)", reportDate: "2024" },
