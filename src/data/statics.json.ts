...
const STATIC_REGIONS: Record<string, StaticSpec> = {
  ...
  jamaica: { annualTWh: 0.2, kind: "solar", localSolarPeakUTC: 17.0, source: "OUR (Office of Utilities Regulation) Jamaica Annual Report 2024 + JPS Integrated Resource Plan 2024 — no public curtailment figure found; JPS is vertically integrated so curtailment decisions are internal and not published in OUR regulatory filings; Wigton Windfarm (62 MW wind) + Content solar are the main VRE assets; 0.2 TWh/yr estimated from installed VRE capacity × typical small-island curtailment rate (~5-8%). T3-modelled, ±40% envelope. Gemini-3.1 research wave 5 (2026-04-30).", reportDate: "2024" },
  ...
  botswana: { annualTWh: 0.05, kind: "solar", localSolarPeakUTC: 10.0, source: "Statistics Botswana Electricity Stats Brief Q1 2025 + BPC Integrated Annual Report 2023/24 — no public solar curtailment figure found; actual curtailment confirmed 0 GWh 2022-2025 (Botswana is in generation deficit, importing 30-50% from SAPP, all solar prioritised for grid; BPC exports surplus off-peak to SAPP rather than curtailing); 0.05 TWh/yr estimated forward-looking anchor as 140 MW BESS + Mmadinare 50 MW solar commissioned 2025. T3-modelled, ±40% envelope. Gemini-3.1 research wave 5 (2026-04-30).", reportDate: "2025" },
