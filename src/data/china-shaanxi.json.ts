  ...
  try {
    ...
    return {
      wind:  buildChinaRegionFromAnchor(
        "china-shaanxi-wind", "wind", 15, 0.4,
        note + " — wind share (~0.4 TWh/yr, northern Shaanxi wind corridor)",
      ),
      solar: buildChinaRegionFromAnchor(
        "china-shaanxi-solar", "solar", 5, 1.1,
        note + " — solar share (~1.1 TWh/yr, Guanzhong basin PV)",
      ),
    };
  }
}
