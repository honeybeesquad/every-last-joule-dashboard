  ...
  try {
    ...
    return {
      wind:  buildChinaRegionFromAnchor(
        "china-hebei-wind", "wind", 15, 2.0,
        note + " — wind share (~2.0 TWh/yr, north China wind corridor, Zhangjiakou transmission bottleneck)",
      ),
      solar: buildChinaRegionFromAnchor(
        "china-hebei-solar", "solar", 4, 0.5,
        note + " — solar share (~0.5 TWh/yr, Zhangjiakou PV + Hebei distributed solar)",
      ),
    };
  }
}
