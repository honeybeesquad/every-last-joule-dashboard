  ...
  try {
    ...
    return {
      wind:  buildChinaRegionFromAnchor(
        "china-jilin-wind", "wind", 15, 1.0,
        note + " — wind share (~1.0 TWh/yr, northeast grid; Baicheng wind corridor)",
      ),
      solar: buildChinaRegionFromAnchor(
        "china-jilin-solar", "solar", 4, 0.2,
        note + " — solar share (~0.2 TWh/yr, growing PV in Changchun/southern corridor)",
      ),
    };
  }
}
