...
<p class="methodology-deck">This dashboard is a live working proof of the arithmetic in a forthcoming book on Bitcoin and energy — a public ledger of curtailed and wasted renewable electricity, updated every few hours and sourced exclusively from grid operators and regulators.</p>
...
- **DARI** (Digital Assets Research Institute) — [da-ri.org](https://da-ri.org)
