...
export const DATA_LOADERS = [
  ...
  { key: "spainEsios",          file: FileAttachment("../data/spain-esios.json"),          label: "Spain ESIOS" },
  ...
  { key: "dominican",           file: FileAttachment("../data/dominican.json"),            label: "Dominican Republic OC SENI" },
  ...
  { key: "indiaGridIndia",      file: FileAttachment("../data/india-grid-india.json"),     label: "Grid-India CEA" },
  ...
  { key: "eiaVreBas",           file: FileAttachment("../data/eia-vre-bas.json"),           label: "EIA VRE balancing authorities" },
  { key: "tsoGridMarkers",      file: FileAttachment("../data/tso-grid-markers.json"),      label: "TSO grid markers" },
