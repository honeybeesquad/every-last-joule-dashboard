...
export const REGIONS: Region[] = [
  ...
  { id: "colombia",         name: "Colombia",        country: "COL", lat: 4.6, lon: -74.1, tier: "static", kind: "hydro", source: "XM SinerGox API (servapibi.xm.com.co/daily, MetricId=VertEner, Entity=Sistema) — system-wide vertimientos hidráulicos (reservoir-overflow energy-equivalent spillage). 5-year mean (2020-2024): 7.53 TWh/yr; range 0.53-13.12 TWh/yr driven by ENSO cycles. Verified 2026-04-30 via Colombian-egress probe through XM's open API (no auth required). Gemini-3.1's cited Feb-2025 figure (705.24 GWh-mes) confirmed exactly via the same API. Same wasted-renewable-energy modelling treatment as Iceland (5.3 TWh/yr) and Sichuan (30 TWh/yr). Bimodal hydro-seasonal shape lags rainfall by reservoir-fill cycle. T1a promotion is on the table once a persistent Colombian-egress relay is wired (XM API is geoblocked outside Colombia).", sourceUrl: "https://servapibi.xm.com.co/daily" },
