...
export const REGIONS: Region[] = [
  ...
  { id: "malaysia",         name: "Malaysia",        country: "MYS", lat:   3.5, lon: 102.0, tier: "live-domestic-anchored", kind: "solar", source: "GSO Malaysia Grid System Operator real-time solar actuals × IRENA/ST 2024 annual anchor (T1b: live measured diurnal shape, domestic anchor, no published curtailment rate)", sourceUrl: "https://www.gso.org.my/" },
  { id: "philippines-solar", name: "Philippines Solar", country: "PHL", lat: 14.6, lon: 121.0, tier: "live", kind: "solar", source: "IEMOP RTD dispatch × 2% curtailment calibration (WESM Luzon/Visayas/Mindanao)", sourceUrl: "https://www.iemop.ph/market-data/rtd-prices-and-schedules/" },
  { id: "philippines-wind",  name: "Philippines Wind",  country: "PHL", lat: 14.6, lon: 121.0, tier: "live", kind: "wind",  source: "IEMOP RTD dispatch × 2% curtailment calibration (WESM Luzon/Visayas/Mindanao)", sourceUrl: "https://www.iemop.ph/market-data/rtd-prices-and-schedules/" },
  ...
  { id: "taiwan",           name: "Taiwan",          country: "TWN", lat:  23.9, lon: 120.4, tier: "live-domestic-anchored", kind: "mixed", source: "TAIPOWER real-time unit dispatch (genary.json); domestic curtailment anchor from TAIPOWER 2024 + IRENA/TREC", sourceUrl: "https://www.taipower.com.tw/d006/loadGraph/loadGraph/genshx_.html" },
  ...
  { id: "dominican-republic", name: "Dominican Republic",   country: "DOM", lat: 18.5, lon:  -69.9, tier: "live-domestic-anchored", kind: "solar", source: "OC (Organismo Coordinador del SENI) live generation feed (GetGeneracionReprogramadaJSon); IRENA 2024 + OC 2024 annual anchor ~0.5 TWh/yr (T1b: live measured shape, domestic anchor)", sourceUrl: "https://apps.oc.org.do/wsOCWebsiteChart/Service.asmx" },
