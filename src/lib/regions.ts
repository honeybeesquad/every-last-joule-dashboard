...
export const REGIONS: Region[] = [
  ...
  { id: "colombia",         name: "Colombia",        country: "COL", lat: 4.6, lon: -74.1, tier: "live", kind: "hydro", source: "XM SinerGox API via Britta daily relay — system-wide vertimientos hidráulicos. T1b-CSV: trailing-365-day mean from committed daily CSV (Britta cron 18:30 UTC). 5-yr baseline 7.53 TWh/yr (range 0.53–13.12 TWh/yr ENSO-driven). Bimodal hydro-seasonal shape (Apr–Jun + Oct–Nov peaks).", sourceUrl: "https://servapibi.xm.com.co/daily" },
  { id: "mexico",           name: "Mexico",          country: "MEX", lat: 25.0, lon: -103.0, tier: "static", kind: "solar", source: "SENER PRODESEN 2024-2038 + CRE confiabilidad reports — ~1.2 TWh/yr solar+wind curtailment from northern-grid transmission saturation (Sonora/Chihuahua/Coahuila/Oaxaca). Excludes hydro vertimientos. Gemini-3.1 research wave 2 (2026-04-30).", sourceUrl: "https://www.gob.mx/sener/documentos/programa-de-desarrollo-del-sistema-electrico-nacional-2024-2038" },
  { id: "japan-chubu",      name: "Chubu (Japan)",   country: "JPN", lat: 35.18, lon: 136.91, tier: "live",   kind: "solar", source: "Chubu Electric Power Grid juyo CSV × 1% calibrated curtailment (OCCTO FY2024 Chubu anchor: ~0.05 TWh/yr)", sourceUrl: "https://denki-yoho.chuden.jp/" },
  { id: "japan-chugoku",   name: "Chugoku (Japan)", country: "JPN", lat: 34.39, lon: 132.45, tier: "live",   kind: "solar", source: "Chugoku Electric juyo CSV (5-min solar) × 6% calibrated curtailment (OCCTO FY2024 Chugoku anchor: ~0.40 TWh/yr)", sourceUrl: "https://www.energia.co.jp/nw/jukyuu/sys/" },
  { id: "japan-hokkaido",  name: "Hokkaido (Japan)", country: "JPN", lat: 43.06, lon: 141.35, tier: "live",  kind: "solar", source: "Hokkaido Electric juyo CSV (5-min solar) × 5% calibrated curtailment (OCCTO FY2024 Hokkaido anchor: ~0.10 TWh/yr)", sourceUrl: "https://denkiyoho.hepco.co.jp/" },
  { id: "japan-hokuriku",  name: "Hokuriku (Japan)", country: "JPN", lat: 36.57, lon: 136.63, tier: "live",  kind: "solar", source: "Hokuriku Electric juyo CSV (5-min solar) × 1% calibrated curtailment (OCCTO FY2024 Hokuriku anchor: ~0.02 TWh/yr)", sourceUrl: "https://www.rikuden.co.jp/nw/denki-yoho/" },
  { id: "japan-kansai",    name: "Kansai (Japan)",  country: "JPN", lat: 34.69, lon: 135.50, tier: "live",   kind: "solar", source: "Kansai Electric T&D juyo CSV (5-min solar, live) × 1% calibrated curtailment (OCCTO FY2024 Kansai anchor: ~0.05 TWh/yr)", sourceUrl: "https://www.kansai-td.co.jp/" },
  { id: "japan-kyushu",    name: "Kyushu (Japan)",  country: "JPN", lat: 33.0, lon:  131.0, tier: "live",    kind: "solar", source: "Kyushu Electric area-demand CSV (5-min solar) × 10% calibrated curtailment (OCCTO FY2024 Kyushu anchor: ~1.7 TWh/yr)", sourceUrl: "https://www.kyuden.co.jp/td_power_usages/pc.html" },
  { id: "japan-okinawa",   name: "Okinawa (Japan)", country: "JPN", lat: 26.21, lon: 127.68, tier: "live",   kind: "solar", source: "Okinawa Electric juyo CSV × 2% calibrated curtailment (OCCTO FY2024 Okinawa anchor: ~0.04 TWh/yr)", sourceUrl: "https://www.okiden.co.jp/" },
  { id: "japan-shikoku",   name: "Shikoku (Japan)", country: "JPN", lat: 34.34, lon: 134.04, tier: "live",   kind: "solar", source: "Shikoku Electric T&D juyo CSV × 7% calibrated curtailment (OCCTO FY2024 Shikoku anchor: ~0.30 TWh/yr)", sourceUrl: "https://www.yonden.co.jp/nw/" },
  { id: "japan-tepco",     name: "TEPCO (Japan)",   country: "JPN", lat: 35.68, lon: 139.69, tier: "live",   kind: "solar", source: "TEPCO Power Grid juyo CSV × 1% calibrated curtailment (OCCTO FY2024 TEPCO anchor: ~0.05 TWh/yr)", sourceUrl: "https://www.tepco.co.jp/forecast/" },
  { id: "japan-tohoku",    name: "Tohoku (Japan)",  country: "JPN", lat: 38.3, lon: 140.5,  tier: "live",    kind: "solar", source: "Tohoku Electric area supply/demand CSV — direct 太陽光出力制御量+風力出力制御量 columns (MW, 30-min). Solar-dominant (>95% of measured curtailment). FY2023 OCCTO anchor: 0.13 TWh; rising ~1.5-2 TWh/yr.", sourceUrl: "https://setsuden.nw.tohoku-epco.co.jp/common/demand/realtime_jukyu/" },
  ...
  { id: "malaysia",         name: "Malaysia",        country: "MYS", lat:   3.5, lon: 102.0, tier: "static", kind: "solar", source: "IRENA Malaysia 2024 + Suruhanjaya Tenaga (ST) 2024 anchor (~0.15 TWh/yr provisional). Gemini-3.1 research wave 2026-04-29: SEDA / ST policy classifies systemic renewable curtailment as a 'rising risk' for Peninsular Malaysia but reports current operations as stable; no published annual curtailment TWh figure exists yet. Live promotion attempt reverted (GSO real-time solar feed is generation-only, not curtailment). Held at T3 pending publication of a real curtailment figure.", sourceUrl: "https://www.gso.org.my/" },
  ...
  { id: "taiwan",           name: "Taiwan",          country: "TWN", lat:  23.9, lon: 120.4, tier: "static", kind: "mixed", source: "TAIPOWER + TREC + IRENA 2024 anchor. Live promotion attempt 2026-04-29 reverted: TAIPOWER `genary.json` exposes current-unit output and instantaneous renewable percentages, not a 30-day public curtailment archive or single published curtailment rate. Held at T3 pending the archive/rate chain.", sourceUrl: "https://www.taipower.com.tw/d006/loadGraph/loadGraph/genshx_.html" },
  { id: "jordan",           name: "Jordan",          country: "JOR", lat:  30.8, lon:  35.8, tier: "static", kind: "solar", source: "NEPCO fallback", sourceUrl: "https://www.nepco.com.jo/" },
  { id: "saudi-solar",      name: "Saudi Arabia (solar)", country: "SAU", lat: 25.5, lon: 46.5, tier: "static", kind: "solar", source: "GASTAT 2024 (5.2% curtailment ~0.8 TWh; grid constraints vs Sudair/Sakaka/NEOM scale-up). Gemini-3.1 research wave 4 (2026-04-30).", sourceUrl: "https://www.stats.gov.sa/" },
  ...
  { id: "pakistan",         name: "Pakistan",        country: "PAK", lat:  28.0, lon:  67.5, tier: "static", kind: "mixed", source: "NEPRA State of Industry Report 2024: Non-Project Missed Volume (NPMV) for wind power = 1,337 GWh FY2023-24 = PKR 39.5 billion in transmission-constrained dispatch-down compensation (Jhimpir/Gharo/Thatta wind corridor, Sindh). Solar curtailment exists but not separately quantified. Gemini-3.1 research wave 2 (2026-04-30).", sourceUrl: "https://nepra.org.pk/publications/State%20of%20Industry%20Reports/State%20of%20Industry%20Report%202024.pdf" },
  { id: "nepal",            name: "Nepal",           country: "NPL", lat:  28.0, lon:  84.0, tier: "static", kind: "hydro", source: "World Bank Nepal Development Update 2024 — estimated >0.5 TWh/yr renewable energy spillage from monsoon-season run-of-river overgeneration vs transmission bottlenecks and limited India-export capacity. NEA confirms during FY2023/24. Same modelling treatment as Ethiopia/Iceland/Colombia hydro spillage. Himalayan summer-monsoon shape (peak Jul-Sep). Gemini-3.1 research wave 4 (2026-04-30, reliability 5/5).", sourceUrl: "https://www.worldbank.org/en/country/nepal/publication/nepal-development-update" },
  ...
  { id: "florida",          name: "Florida",        country: "USA", lat:  27.6,  lon:  -81.2, tier: "static", kind: "solar", source: "EIA FLA solar generation exists, but no published curtailment rate from FRCC/FPL. 0.5 TWh/yr provisional anchor — requires FRCC market monitor or FPL IRP 2024 published curtailment figure to move to T1.", sourceUrl: "https://www.eia.gov/opendata/browser/electricity/rto/fuel-type-data" },
  ...
  { id: "cabo-verde",       name: "Cabo Verde",        country: "CPV", lat:  14.93, lon:  -23.51, tier: "static", kind: "solar", source: "IRENA Cabo Verde 2024 (ELECTRA; 9-island system; high VRE)", sourceUrl: "https://www.electra.cv/" },
  ...
  { id: "cote-divoire",     name: "Cote d'Ivoire",     country: "CIV", lat:   5.32, lon:   -4.02, tier: "static", kind: "solar", source: "IRENA Cote d'Ivoire 2024 (CIE; major WAPP exporter)", sourceUrl: "https://www.cie.ci/" },
  { id: "eswatini",         name: "Eswatini",          country: "SWZ", lat: -26.31, lon:   31.13, tier: "static", kind: "solar", source: "IRENA Eswatini 2024 (EEC; SAPP member; biomass+hydro)", sourceUrl: "https://www.eec.co.sz/" },
  ...
  { id: "ghana",            name: "Ghana",             country: "GHA", lat:   5.61, lon:   -0.20, tier: "static", kind: "solar", source: "Ember Ghana 2024 (GRIDCo TSO; Akosombo hydro + PV)", sourceUrl: "https://www.gridcogh.com/" },
  ...
  { id: "mauritius",        name: "Mauritius",         country: "MUS", lat: -20.16, lon:   57.51, tier: "static", kind: "solar", source: "IRENA Mauritius 2024 (CEB; bagasse+coal+oil + PV; island)", sourceUrl: "https://ceb.mu/" },
  ...
  { id: "nigeria",          name: "Nigeria",           country: "NGA", lat:   9.00, lon:    8.50, tier: "static", kind: "solar", source: "Ember Nigeria 2024 + TCN 2024 (solar curtailment; Niger Delta flare ~7 TWh-eq/yr is a separate flat-baseload signal)", sourceUrl: "https://www.tcn.org.ng/" },
  ...
  { id: "senegal",          name: "Senegal",           country: "SEN", lat:  14.69, lon:  -17.45, tier: "static", kind: "solar", source: "IRENA Senegal 2024 (SENELEC; Taiba N'Diaye 158 MW wind + PV)", sourceUrl: "https://www.senelec.sn/" },
  ...
  { id: "tunisia",          name: "Tunisia",           country: "TUN", lat:  36.81, lon:   10.18, tier: "static", kind: "solar", source: "IRENA Tunisia 2024 + STEG Annual Report (Bizerte wind + PV; gas-dominated)", sourceUrl: "https://www.steg.com.tn/" },
