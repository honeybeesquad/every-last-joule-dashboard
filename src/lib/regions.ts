...
export const REGIONS: Region[] = [
  ...
  { id: "colombia",         name: "Colombia",        country: "COL", lat: 4.6, lon: -74.1, tier: "static", kind: "hydro", source: "XM Informe de Operación SIN — vertimientos hidráulicos (hydro spillage when reservoirs exceed storage during bimodal Apr-May / Oct-Nov rainy seasons). Gemini-3.1 research wave 2026-04-29 cited a 705.24 GWh single-month figure for Feb-2025 vertimientos; XM site is geoblocked from outside Colombia preventing direct verification, so a conservative 2.0 TWh/yr annualisation is used as the T3 anchor. UPME / SER Colombia note that VRE (solar/wind) curtailment is currently <1% of generation — the wasted-energy story is dominated by hydro spillage, not VRE curtailment. Same modelling approach as Iceland (5.3 TWh/yr) and Sichuan (30 TWh/yr). Bimodal hydro-seasonal shape lagging the rainy-season peaks by reservoir-fill cycle.", sourceUrl: "https://www.xm.com.co/informacion-y-servicios/informes/informes-de-operacion" },
