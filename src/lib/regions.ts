...
export const REGIONS: Region[] = [
  ...
  { id: "philippines",      name: "Philippines",     country: "PHL", lat:  14.6, lon: 121.0, tier: "static", kind: "solar", source: "IEMOP / NGCP / PEMC composite anchor (~0.5 TWh/yr provisional). Gemini-3.1 research wave 2026-04-29: NGCP Transmission Development Plan 2025-2050 cites ~12% off-peak curtailment in Ilocos Norte 2024, but no nationwide annual TWh figure published. Anchor remains a defensible mid-range estimate pending IEMOP/PEMC publishing a system-wide curtailment volume.", sourceUrl: "https://www.iemop.ph/the-market/market-data/" },
