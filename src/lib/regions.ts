...
export const REGIONS: Region[] = [
  ...
  { id: "malaysia",         name: "Malaysia",        country: "MYS", lat:   3.5, lon: 102.0, tier: "static", kind: "solar", source: "IRENA Malaysia 2024 + Suruhanjaya Tenaga (ST) 2024 anchor. Live promotion attempt 2026-04-29 reverted: GSO real-time solar feed exposes current-day generation arrays, not a 30-day curtailed-energy archive or citable curtailment rate. Held at T3 pending a genuine curtailment source.", sourceUrl: "https://www.gso.org.my/" },
