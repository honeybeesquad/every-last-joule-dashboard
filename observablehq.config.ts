...
const OG_DESCRIPTION =
  "The wasted-energy database: renewable-electricity curtailment across 374 regions worldwide, live from grid operators. How much of Bitcoin's hashrate could run on the joules we already pay for but throw away?";
...
const socialMeta = [
  ...
  `<meta property="og:image:alt" content="Globe showing wasted-energy pillars from renewable-electricity curtailment across 374 regions; headline shows the share of Bitcoin hashrate supportable on the joules we already throw away.">`,
