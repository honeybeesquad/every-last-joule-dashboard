...
Branch `feat/redesign-tablet-phone`, **stacked on PR 3 (#1092), which must
merge first**. The plan is
`docs/superpowers/plans/2026-09-23-light-dark-redesign.md`; its "PR 4 as
