...
**Last verified against git:** 2026-06-20 (#246 China provincial, #247 AEMO+Ontario per-plant, #255 Peru per-plant rebuild — all absorbed into main. Previously: #163 granularity-gaps survey, #149 accuracy gates, CI automation fix #135, PRs #128–#132)
...
**Coverage — full world:**
- 473 regions across 195 countries (every UN member + Taiwan + Palestine) — **renewables-only** (curtailed solar/wind/hydro); flare gas purged 2026-06-18.
- **Tally golden as of 2026-06-20: T1a=172, T1b=26, T1c=1, T2=24, T3=250 (total 473).** Counted directly from `src/lib/regions.ts`. Locked by `tests/regions.test.ts` + `scripts/ci/golden/tier-counts.json`. Chain: 431 (post-flare-purge 2026-06-18) → 439 (#246 China provincial +8 T3) → 461 (#247 AEMO+Ontario per-plant +22 T1a; T1a 150→172) → 473 (#255 Peru per-plant rebuild +12 T3; T3 238→250). **The `T2-flare` bucket is retired** — the 2026-06-18 flare-gas purge removed all 37 flare regions (34 anchored + 3 estimated offshore: trinidad/guyana/suriname) and the bucket itself (total 468→431). Earlier drift (2026-06-10 golden total 385): EIA-930 9 US BAs +18 T2 (#163); China/India/Chile/Colombia/Ukraine expansion (#203/#206); Germany DE-LU → 4 TSO control areas (#214); Mexico per-fuel split (#216); estonia/south-korea per-fuel splits; GGFR flare per-site split (#220 → 468, since purged).
