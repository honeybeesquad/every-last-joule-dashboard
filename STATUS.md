...
**Left pinned on purpose:** `dataset/README.md`, `CITATION.cff`, `.zenodo.json` stay at **v1.3.2** (`10.5281/zenodo.20570864`) — 385 regions, still includes flare. No silent retcon of the mint. Root README citation no longer says Scientific Data is “in review.”

**Still open:** regenerate `docs/figures/figure{1,4}_*` (committed images still show the flare palette). No flare-free Zenodo cut yet. **No tier moved.** Methodology §2.1 headers kept in the `ci:methodology-counts` format.
