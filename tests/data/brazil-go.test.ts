...
describe("brazil-go ONS routing", () => {
  it("routes Goias rows to brazil-go", () => {
    const csv = [
      ...
      "SE;SUDESTE;GO;GOIAS;PLANT;A;-;2026-03-01 00:00:00;0;99;0;0;2.5;;;",
    ].join("\n");
    expect(parseOnsCurtailmentCsv(csv)["brazil-go"][0].mw).toBe(2.5);
  });
});
