...
describe("brazil-mg ONS routing", () => {
  it("routes Minas Gerais rows to brazil-mg", () => {
    const csv = [
      ...
      "SE;SUDESTE;MG;MINAS GERAIS;PLANT;A;-;2026-03-01 00:00:00;0;99;0;0;2.5;;;",
    ].join("\n");
    expect(parseOnsCurtailmentCsv(csv)["brazil-mg"][0].mw).toBe(2.5);
  });
});
