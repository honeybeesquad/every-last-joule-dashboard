...
- **Live HEAD** (`npm run tally:tiers`): **T1a 160, T1b 26, T1c 1, T2 22, T3 327 — total 536**, matching `scripts/ci/golden/tier-counts.json`. No flare bucket. T2 is six annual-anchored flats plus sixteen EIA-930 second-tier US balancing authorities (live shape, external rate). Grid-completeness unpublished TSO rows sit in T3. The archived **v1.4.0** deposit predates this expansion.
