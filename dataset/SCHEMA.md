...
Three artifact families are published: source-verified annual floor tables, per-region JSON snapshots (one file per region, overwritten on each build), and rolling/historical Parquet time-series.
